			...
			html = html + "<form class=\"form-horizontal\" action=\"nuevousuario\" method=\"POST\" >";
				...
				html = html + "<div class=\"control-group\">";
					...
					html = html + "<div class=\"controls\">";
			  			html = html + "<input type=\"text\" id=\"inputFname1\" placeholder=\"Nombre\" required>";
					html = html + "</div>";
			 	html = html + "</div>";
			 	html = html + "<div class=\"control-group\">";
					html = html + "<label class=\"control-label\" for=\"inputLnam\">Apellido <sup>*</sup></label>";
					html = html + "<div class=\"controls\">";
				  		html = html + "<input type=\"text\" id=\"inputLnam\" placeholder=\"Apellido\" required>";
					html = html + "</div>";
			 	html = html + "</div>";
				html = html + "<div class=\"control-group\">";
					html = html + "<label class=\"control-label\" for=\"input_email\">Email <sup>*</sup></label>";
					html = html + "<div class=\"controls\">";
			  			html = html + "<input type=\"email\" id=\"input_email\" placeholder=\"Email\" required>";
					html = html + "</div>";
		  		html = html + "</div>	  ";
				html = html + "<div class=\"control-group\">";
					html = html + "<label class=\"control-label\" for=\"inputPassword1\">Contraseña <sup>*</sup></label>";
					html = html + "<div class=\"controls\">";
			  			html = html + "<input type=\"password\" id=\"inputPassword1\" placeholder=\"Contraseña\" required>";
					html = html + "</div>";
		  		html = html + "</div>";
		  		html = html + "<div class=\"control-group\">";
				...
				html = html + "<div class=\"control-group\">";
					...
					html = html + "<div class=\"controls\">";
					  html = html + "<input type=\"text\" id=\"address\" placeholder=\"Dirección\" required/> <span>Calle y número</span>";
					html = html + "</div>";
				html = html + "</div>";
				html = html + "<div class=\"control-group\">";
					html = html + "<label class=\"control-label\" for=\"address2\">Dirección (Adicional) </label>";
					html = html + "<div class=\"controls\">";
					  html = html + "<input type=\"text\" id=\"address2\" placeholder=\"Dirección (Adicional)\"/> <span>Piso, departamento, etc.</span>";
					html = html + "</div>";
				html = html + "</div>";
				html = html + "<div class=\"control-group\">";
					html = html + "<label class=\"control-label\" for=\"phone\">Teléfono <sup>*</sup></label>";
					html = html + "<div class=\"controls\">";
				  		html = html + "<input type=\"text\"  name=\"phone\" id=\"phone\" placeholder=\"Teléfono\" required/>";
					html = html + "</div>";
				html = html + "</div>";
				html = html + "<div class=\"control-group\">";
					html = html + "<div class=\"controls\">";
